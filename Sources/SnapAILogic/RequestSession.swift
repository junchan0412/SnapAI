...
package struct RequestSessionPayload {
    package var messages: [ChatMessage]
    package var hasImage: Bool
}

package enum RequestSession {
    package static func initialMessages(settings: AppSettings,
                                action: AIAction,
    ...
    package static func appendFollowUp(to messages: inout [ChatMessage],
    ...
    package static func userContent(renderedText: String,
    ...
    package static func payloadCharacterCounts(messages: [ChatMessage]) -> (finalUserPrompt: Int, systemPrompt: Int) {
