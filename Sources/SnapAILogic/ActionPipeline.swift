...
package struct ActionPipelineDiagnostic: Equatable {
    package var inputPolicy: String
    package var privacyPolicy: String
    package var outputPolicy: String
    package var modelPolicy: String
    ...
    package static let empty = ActionPipelineDiagnostic(inputPolicy: "not-recorded",
                                                privacyPolicy: "not-recorded",
                                                outputPolicy: "not-recorded",
                                                modelPolicy: "not-recorded")

    package static func make(action: AIAction,
