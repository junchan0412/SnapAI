...
package enum SelectionSourceKind: String, Codable, Equatable {
...
package struct SelectionSourceContext: Equatable {
    package var kind: SelectionSourceKind
    package var appName: String?

    package var sanitizedAppName: String {
    ...
    package var promptPrefix: String {
        """
        [SnapAI 选区来源]
    ...
    package static func make(appName: String?) -> SelectionSourceContext {
        SelectionSourceContext(kind: classify(appName: appName), appName: appName)
    }

    package static func classify(appName: String?) -> SelectionSourceKind {
