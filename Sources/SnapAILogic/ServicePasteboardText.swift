...
package enum ServicePasteboardText {
    package static let supportedPlainTextTypes: [NSPasteboard.PasteboardType] = [
        .string,
    ...
    package static func text(from pasteboard: NSPasteboard) -> String? {
