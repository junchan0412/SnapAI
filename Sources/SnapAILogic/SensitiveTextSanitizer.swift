...
package enum SensitiveTextSanitizer {
    ...
    package static func sanitizedDiagnosticText(_ message: String, limit: Int = 4_000) -> String {
    ...
    package static func redactedLocalPaths(_ message: String,
