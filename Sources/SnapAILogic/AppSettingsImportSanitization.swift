...
extension AppSettings {
    package func exportConfigurationData() -> Data? {
    ...
    package static func providersForImportedConfiguration(_ providers: [AIProvider],
    ...
    package static func importedProviderConfiguration(_ providers: [AIProvider],
    ...
    package static func sanitizedStoredProviders(_ providers: [AIProvider]) -> [AIProvider] {
        var seenProviderIDs = Set<String>()
        return providers.prefix(importedProviderLimit).map { provider in
            var copy = provider
    ...
    package func normalizeImportedConfiguration() {
    ...
    package static func clampedTemperature(_ value: Double) -> Double {
        guard value.isFinite else { return 0.3 }
        return min(max(value, 0), 1)
    }

    package static func clampedHistoryLimit(_ value: Int) -> Int {
        min(max(value, importedHistoryLimitRange.lowerBound), importedHistoryLimitRange.upperBound)
    }

    package static func clampedPanelWidth(_ value: Double) -> Double {
        clampedPanelDimension(value,
                              fallback: defaultPanelWidth,
                              range: importedPanelWidthRange)
    }

    package static func clampedPanelHeight(_ value: Double) -> Double {
        clampedPanelDimension(value,
    ...
    package static func sanitizedImportedModels(_ models: [AIModelEntry]) -> [AIModelEntry] {
    ...
    package static func sanitizedImportedActions(_ actions: [AIAction]) -> [AIAction] {
    ...
    package static func sanitizedImportedActions(_ actions: [AIAction],
    ...
    package static func sanitizedStoredHistory(_ entries: [HistoryEntry], limit: Int) -> [HistoryEntry] {
    ...
    package static func sanitizedStoredSavedHistoryFilters(_ filters: [SavedHistoryFilter]) -> [SavedHistoryFilter] {
        var seenIDs = Set<String>()
        var seenNames = Set<String>()
    ...
    package static func sanitizedHistoryFilterCriteria(_ criteria: HistoryFilterCriteria) -> HistoryFilterCriteria {
    ...
    package static func sanitizedSavedHistoryFilterName(_ name: String) -> String {
    ...
    package static func savedHistoryFilterNameKey(_ name: String) -> String {
    ...
    package static func sanitizedImportedProviderTemperature(_ value: Double?) -> Double? {
        guard let value, value.isFinite else { return nil }
        return clampedTemperature(value)
    }

    package static func sanitizedImportedMaxTokens(_ value: Int?) -> Int? {
        guard let value, value > 0 else { return nil }
        return min(max(value, importedMaxTokensRange.lowerBound), importedMaxTokensRange.upperBound)
    }

    package static func sanitizedImportedRequestTimeout(_ value: Double?) -> Double? {
        guard let value, value.isFinite, value > 0 else { return nil }
        return min(max(value, importedRequestTimeoutRange.lowerBound), importedRequestTimeoutRange.upperBound)
    }

    package static func sanitizedImportedRedactionRules(_ rules: [PrivacyRedactionRule]) -> [PrivacyRedactionRule] {
    ...
    package static func sanitizedStoredRedactionRules(_ rules: [PrivacyRedactionRule]) -> [PrivacyRedactionRule] {
        guard !rules.isEmpty else { return [] }
        var seenIDs = Set<String>()
    ...
    package static func sanitizedImportedContextProfiles(_ profiles: [ContextProfile],
    ...
    package static func sanitizedStoredContextProfiles(_ profiles: [ContextProfile],
                                               activeID: String) -> (profiles: [ContextProfile], activeID: String) {
        sanitizedImportedContextProfiles(profiles, activeID: activeID)
    }

    package static func sanitizedStoredActionUsageCounts(_ counts: [String: Int]) -> [String: Int] {
    ...
    package static func sanitizedPrompt(_ value: String?,
                                fallback: String,
    ...
    package static func limitedImportedString(_ value: String,
                                      maxLength: Int,
    ...
    package static func sanitizedActiveModelName(_ value: String) -> String {
        limitedImportedString(value.trimmingCharacters(in: .whitespacesAndNewlines),
                              maxLength: importedModelNameLimit,
                              fallback: "")
    }

    package static func providerIDAfterProviderSanitization(originalProviders: [AIProvider],
