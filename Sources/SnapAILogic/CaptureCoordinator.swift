...
public enum CaptureTargetSource: String, Equatable {
...
public enum CaptureTargetResolver {
    public static func preferredDeferredSource(serviceInvocationPID: pid_t?,
    ...
    public static func preferredSource(frontmostPID: pid_t?,
                                       frontmostIsTerminated: Bool,
                                       frontmostBundleIdentifier: String? = nil,
                                       lastExternalPID: pid_t?,
                                       lastExternalIsTerminated: Bool,
    ...
    public static func resolve(frontmost: NSRunningApplication?,
    ...
    public static func resolveDeferred(serviceInvocation: NSRunningApplication?,
    ...
    public static func isUsableExternalApp(pid: pid_t?,
                                           isTerminated: Bool,
