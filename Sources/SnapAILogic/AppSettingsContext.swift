...
extension AppSettings {
    package var activeContextProfile: ContextProfile? {
    ...
    package var effectiveSystemPrompt: String {
    ...
    package var effectiveSystemPromptMarkdownExport: String {
    ...
    package var contextStatusSummary: ContextStatusSummary {
        ContextStatusSummary.make(settings: self)
    }

    package var contextStatusMarkdownExport: String {
    ...
    package func hasContextProfile(named name: String) -> Bool {
        contextProfileIndex(named: name) != nil
    }

    @discardableResult
    package func upsertContextProfile(from draft: HistoryContextProfileDraft) -> ContextProfileUpsertResult {
