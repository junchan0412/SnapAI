...
public enum CommandIdentifier {
    public static func uniqued(_ ids: [String]) -> [String] {
        var usedIDs = Set<String>()
        return ids.map { unique(base: $0, usedIDs: &usedIDs) }
    }

    public static func unique(base: String, usedIDs: inout Set<String>) -> String {
    ...
    public static func unique(prefix: String, values: [String], usedIDs: inout Set<String>) -> String {
