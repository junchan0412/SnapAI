...
public struct WriteBackCompatibilityProfile: Equatable {
  public var appNames: [String]
  public var displayName: String
  public var recoveryHint: String

  public init(appNames: [String], displayName: String, recoveryHint: String) {
...
public enum WriteBackCompatibility {
  public static let profiles: [WriteBackCompatibilityProfile] = [
  ...
  public static func profile(for appName: String?) -> WriteBackCompatibilityProfile? {
  ...
  public static func recoveryHint(for appName: String?) -> String? {
    profile(for: appName)?.recoveryHint
  }

  public static func diagnosticSummary(for appName: String?) -> String {
