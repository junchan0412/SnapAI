...
package enum LocalModelServiceKind: String, Equatable {
    case ollama = "Ollama"
    case lmStudio = "LM Studio"
    case localOpenAI = "本地 OpenAI 兼容服务"
}

package struct LocalModelHealth: Equatable {
    package var serviceKind: LocalModelServiceKind
    ...
    package var serviceStartHint: String {
        switch serviceKind {
        case .ollama:
    ...
    package var modelSetupHint: String {
        switch serviceKind {
        case .ollama:
    ...
    package func recoverySuggestion(for readiness: AIRequestRouter.ProviderReadiness) -> String? {
        switch readiness {
        case .missingAPIKey:
    ...
    package static func make(provider: AIProvider) -> LocalModelHealth? {
