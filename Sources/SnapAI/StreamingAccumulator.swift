...
struct StreamingAccumulator: Equatable {
    ...
    mutating func appendContentToken(_ token: String, extractsThinkTags: Bool) {
    ...
    mutating func appendExternalThinking(_ text: String) {
        thinkingText += text
    }
    ...
    mutating func resetForFallback() {
        outputText = ""
        thinkingText = ""
        inThinkTag = false
        bufferedTagFragment = ""
