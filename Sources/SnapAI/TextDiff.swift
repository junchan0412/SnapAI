...
struct TextDiffRow: Identifiable, Equatable {
    let id = UUID()
    var original: String?
    var revised: String?
...
struct TextDiffSummary: Equatable {
    var inserted: Int = 0
    var deleted: Int = 0
    var changed: Int = 0
...
enum TextDiff {
    ...
    static func rows(original: String, revised: String, maxRows: Int? = nil) -> [TextDiffRow] {
    ...
    static func summary(for rows: [TextDiffRow]) -> TextDiffSummary {
