...
enum CommandPaletteMatcher {
    ...
    static func matches(title: String,
                        subtitle: String,
                        keywords: String,
                        query: String) -> Bool {
    ...
    static func score(title: String,
                      subtitle: String,
                      keywords: String,
                      query: String) -> Int? {
    ...
    static func ranked<T>(_ items: [T],
                          query: String,
    ...
    static func shortcutSearchKeywords(_ shortcutText: String?) -> String {
