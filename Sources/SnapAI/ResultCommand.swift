...
enum ResultCommandAction: Equatable {
    case copyOutput
    case copyMarkdown
...
struct ResultCommandState: Equatable {
    var hasResult: Bool
    var hasDiagnostics: Bool
    var canWriteBack: Bool
    var isStreaming: Bool
    var hasSourceText: Bool
    var protectsContentExport: Bool = false
    var recoveryCode: String? = nil
}

extension ResultCommandState {
...
struct ResultCommandDescriptor: Equatable {
    var id: String
    var title: String
    var subtitle: String
    var systemImage: String
    var keywords: String
    var action: ResultCommandAction
}

enum ResultMenuModifier: String, Equatable {
    case command
    case option
    case shift
}

struct ResultMenuCommandDescriptor: Equatable {
    var id: String
    var title: String
    var keyEquivalent: String
    var modifiers: [ResultMenuModifier]
    var action: ResultCommandAction
}

enum ResultCommandFactory {
    static func descriptor(for action: ResultCommandAction) -> ResultCommandDescriptor {
        descriptor(for: action, protectsContentExport: false, recoveryCode: nil)
    }

    static func descriptor(for action: ResultCommandAction,
    ...
    static func menuDescriptor(for action: ResultCommandAction) -> ResultMenuCommandDescriptor? {
        menuDescriptors().first { $0.action == action }
    }

    static func shortcutText(for action: ResultCommandAction) -> String? {
    ...
    static func helpText(for action: ResultCommandAction) -> String {
        helpText(for: action, protectsContentExport: false)
    }

    static func helpText(for action: ResultCommandAction,
    ...
    static func accessibilityLabel(for action: ResultCommandAction,
                                   in state: ResultCommandState) -> String {
        let descriptor = descriptor(for: action,
                                    protectsContentExport: state.protectsContentExport,
                                    recoveryCode: state.recoveryCode)
    ...
    static func menuTitle(for action: ResultCommandAction,
                          in state: ResultCommandState) -> String {
    ...
    static func menuToolTip(for action: ResultCommandAction,
                            in state: ResultCommandState) -> String? {
    ...
    static func menuDescriptors() -> [ResultMenuCommandDescriptor] {
        [
    ...
    static func descriptors(state: ResultCommandState) -> [ResultCommandDescriptor] {
    ...
    static func descriptors(hasResult: Bool,
                            hasDiagnostics: Bool,
                            canWriteBack: Bool,
                            isStreaming: Bool,
                            hasSourceText: Bool,
    ...
    static func isEnabled(_ action: ResultCommandAction, in state: ResultCommandState) -> Bool {
        switch action {
