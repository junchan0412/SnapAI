...
enum FollowUpHistoryNavigationDirection: Equatable {
    case up
    case down
}

struct FollowUpHistoryStore: Equatable {
    static let defaultLimit = 50
    static let maxEntryCharacters = 4_000
    ...
    var effectiveLimit: Int { max(1, limit) }
    ...
    mutating func record(_ rawText: String) {
    ...
    func shouldHandleNavigation(currentText: String,
