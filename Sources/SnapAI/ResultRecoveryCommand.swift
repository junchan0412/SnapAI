...
struct ResultRecoverySettingsDescriptor: Equatable {
    var title: String
...
struct ResultRecoveryRetryDescriptor: Equatable {
    var title: String
    var compactTitle: String
    var subtitle: String
    var systemImage: String
...
enum ResultRecoveryPrimaryAction: Equatable {
    case retry
    case settings
}

enum ResultRecoveryCommand {
    static var openAISettingsTitle: String { openAISettingsDescriptor(recoveryCode: nil).title }
    static var openAISettingsCompactTitle: String { openAISettingsDescriptor(recoveryCode: nil).compactTitle }
    static var openAISettingsSubtitle: String { openAISettingsDescriptor(recoveryCode: nil).subtitle }
    static var openAISettingsSystemImage: String { openAISettingsDescriptor(recoveryCode: nil).systemImage }
    static var openAISettingsKeywords: String { openAISettingsDescriptor(recoveryCode: nil).keywords }

    static func openAISettingsDescriptor(recoveryCode: String?) -> ResultRecoverySettingsDescriptor {
    ...
    static func retryDescriptor(recoveryCode: String?) -> ResultRecoveryRetryDescriptor {
        switch normalizedRecoveryCode(recoveryCode) {
    ...
    static func primaryAction(recoveryCode: String?) -> ResultRecoveryPrimaryAction {
        switch normalizedRecoveryCode(recoveryCode) {
        case "missing-provider", "missing-model", "no-candidate-routes", "route-unavailable", "api-key", "base-url", "model-not-found":
            return .settings
        default:
