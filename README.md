...
![SnapAI 1.6.4 UI 总览](docs/snapai-ui-overview.svg)
...
详细发布说明见 [SnapAI 1.6.4 Release Notes](docs/RELEASE_NOTES_1.6.4.md),阶段性复盘和全量审查见 [SnapAI 1.6.4 Iteration Report](docs/ITERATION_REPORT_1.6.4.md)。
