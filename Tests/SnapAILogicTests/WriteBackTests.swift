...
func testTextCaptureTargetActivationGuards() {
    ...
    expect(!TextCapture.shouldDismissTransientMenusBeforeCopy(targetPID: currentPID,
                                                             frontmostPID: currentPID + 1,
                                                             currentPID: currentPID,
                                                             forceDismissal: true),
...
func testCaptureTargetResolverUsesRecentExternalAppWhenSnapAIIsFrontmost() {
    let currentPID = pid_t(100)
    expect(CaptureTargetResolver.preferredDeferredSource(serviceInvocationPID: 250,
